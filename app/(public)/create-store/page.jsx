...
export default function CreateStore() {
    ...
    try {
      ...
      if (["approved", "rejected", "pending"].includes(data.status)) {
        ...
        switch (data.status) {
          case "approved":
            setMessage(
              "Your store has been approved, you can now add producs to your store from dashboard."
            );
          ...
          case "pending":
            setMessage(
              "Your store request is pending, please wait for the admin to approve your store."
            );
            break;
  ...
  if (!user) {
    return (
      <div className="min-h-[80vh] max-6 flex items-center justify-center text-slate-600">
